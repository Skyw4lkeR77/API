...
try {
var zitsr = db.get("Skyw4lkeR77");
} catch (e) {
	console.log('')
}

var creatorList = ['@Skyw4lkeR77','@𝐒𝐊𝐘_𝐁𝐎𝐓'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'SkyApi') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'SkyApi') return res.json(loghandler.invalidKey)
